...
public interface CarApi {
    ...
    ResponseEntity<CarDto> save(@RequestBody CarDto dto);
    ...
    ResponseEntity<CarDto> findById(@PathVariable("id_car") Integer id);
    ...
    ResponseEntity<CarDto> findByRegisterNumber(@PathVariable("car_register_number") String registerNumber);
    ...
    ResponseEntity delete(@PathVariable("id_car") Integer id);
}
